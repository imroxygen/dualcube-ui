...
import SubTabSection, { MenuItem } from '../SubTabSection/SubTabSection';
...
const FreeProFormCustomizer: React.FC<FreeProFormCustomizerProps> = ({ setting, proSettingChange, moduleEnabledChange, onChange }) => {
